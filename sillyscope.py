...
class Sillyscope():
    ...
    def __init__(self, name='TCPIP0::172.16.0.101::inst0::INSTR', pyvisa_py=False, simulation=False):
    ...
    def get_waveform(self, channel=1, convert_to_float=True, include_x=False, use_previous_header=False, binary='float32'):
        """
